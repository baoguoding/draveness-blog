...
![JSON-to-Model](https://img.draveness.me/JSON-to-Model.jpg-1000width)
...
![Dynamic-Stati](https://img.draveness.me/Dynamic-Static.png-1000width)
...
![MVCS-Architecture](https://img.draveness.me/MVCS-Architecture.png-1000width)
...
![Abstract-Request](https://img.draveness.me/Abstract-Request.jpg-1000width)
...
![Manager-And-Request](https://img.draveness.me/Manager-And-Request.jpg-1000width)
...
![Model-And-Dictioanry](https://img.draveness.me/Model-And-Dictioanry.jpg-1000width)

单独的 Model 层并不能返回什么关键的作用，它只有与网络服务层 Service 结合在一起的时候才能发挥更重要的能力。

![Service-And-API](https://img.draveness.me/Service-And-API.jpg-1000width)
...
![Server-MV](https://img.draveness.me/Server-MVC.jpg-1000width)
...
![Relation-Between-Database-And-Mode](https://img.draveness.me/Relation-Between-Database-And-Model.jpg-1000width)
...
![web-black-box](https://img.draveness.me/web-black-box.jpg-1000width)

在服务端拿到数据后对其进行处理、加工以及存储，最后仍然以数据的形式返回给用户。

而客户端重展示，其输入就是用户的行为触发的事件，而输出是用户界面：

![client-black-box](https://img.draveness.me/client-black-box.jpg-1000width)
...
![404](https://img.draveness.me/404.gif)
...
![Model-in-Client](https://img.draveness.me/Model-in-Client.jpg-1000width)
...
![JSON-Mode](https://img.draveness.me/JSON-Model.jpg-1000width)
