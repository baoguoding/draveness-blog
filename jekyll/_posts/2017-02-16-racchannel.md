...
![What-is-RACChanne](https://img.draveness.me/2017-02-16-What-is-RACChannel.png-1000width)
...
![Connection-Between-View-Mode](https://img.draveness.me/2017-02-16-Connection-Between-View-Model.png-1000width)

那么从模型发出的消息，最后会发送到视图上；反之，用户对视图进行的操作最后也会体现在模型上。这种通信方式的实现是基于信号的，`RACChannel` 内部封装了两个 `RACChannelTerminal` 对象，它们都是 `RACSignal` 的子类：

![RACChannel-Interface](https://img.draveness.me/2017-02-16-RACChannel-Interface.png-1000width)

对模型进行的操作最后都会发送给 `leadingTerminal` 再通过内部的实现发送给 `followingTerminal`，由于视图是 `followingTerminal` 的订阅者，所以消息最终会发送到视图上。

![Messages-Send-From-Mode](https://img.draveness.me/2017-02-16-Messages-Send-From-Model.png-1000width)
...
![Terminals-Between-View-Mode](https://img.draveness.me/2017-02-16-Terminals-Between-View-Model.png-1000width)
...
![Channel-And-Network-Connection](https://img.draveness.me/2017-02-16-Channel-And-Network-Connection.png-1000width)
...
![RACChannelTerminal-Interface](https://img.draveness.me/2017-02-16-RACChannelTerminal-Interface.png-1000width)
...
![Sending-Errors-And-Completed-Messages](https://img.draveness.me/2017-02-16-Sending-Errors-And-Completed-Messages.png-1000width)
...
![RACChannel-Hierachy](https://img.draveness.me/2017-02-16-RACChannel-Hierachy.png-1000width)
...
![UITextField-RACChannel-Interface](https://img.draveness.me/2017-02-16-UITextField-RACChannel-Interface.png-1000width)
...
![RACKVOChanne](https://img.draveness.me/2017-02-16-RACKVOChannel.png-1000width)
...
![RACChannelTo-Model-Vie](https://img.draveness.me/2017-02-16-RACChannelTo-Model-View.png-1000width)

实现的方式其实与 `RACChannel` 差不多，这里不会深入到代码中进行介绍，与 `RACChannel` 的区别是，`RACKVOChannel` 并没有暴露出 `leadingTerminal` 而是 `followingTerminal`：

![RACChannelTo-And-Property](https://img.draveness.me/2017-02-16-RACChannelTo-And-Property.png-1000width)

## RACChannel 实战

这一小节通过一个简单的例子来解释如何使用 `RACChannel` 进行双向数据绑定。

![TextField-With-Channe](https://img.draveness.me/2017-02-16-TextField-With-Channel.gif)
...
![Two-UITextField-With-RACChanne](https://img.draveness.me/2017-02-16-Two-UITextField-With-RACChannel.png-1000width)
