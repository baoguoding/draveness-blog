...
tags: GraphQL 架构 微服务 服务网格 Linkerd gRPC
toc: true
...
经过评估之后，我们决定在 GraphQL Elixir 实现 [Absinthe](https://github.com/absinthe-graphql/absinthe) 上进行一层包装，并对客户端的请求进行语法与语义的解析，将字段对应的树包装成子查询发送给下游的服务，最终再由最前面的 GraphQL 服务组合起来：
